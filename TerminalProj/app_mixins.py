...
class AnswerCheckMixin:
    ...
    def accepted_answers(self, correct_answer):
        return [str(answer) for answer in correct_answer] if isinstance(correct_answer, (list, tuple, set)) else [str(correct_answer)]
    ...
    def is_correct_answer(self, user_answer, correct_answer):
        ...
        for expected in self.accepted_answers(correct_answer):
